...
import { polarToCartesian, generatePointsCloud } from "../../utils/utils";
import type { Rune } from "../../utils/types";

interface SvgProps {
	rune: Rune;
	parent: Pick<Rune, "radius">;
	x: number;
	y: number;
}

export default function Svg({ rune, parent, x, y }: SvgProps) {
